...
const trendData = [
  ...
  { name: 'Sem 3', valor: 550 },
  { name: 'Sem 4', valor: 450 },
  { name: 'Sem 5', valor: 700 },
];
...
// Main temporal data
const data = [
  { name: 'Jan', receita: 4000, usuarios: 2400 },
  { name: 'Fev', receita: 3000, usuarios: 1398 },
  { name: 'Mar', receita: 2000, usuarios: 9800 },
  { name: 'Abr', receita: 2780, usuarios: 3908 },
  { name: 'Mai', receita: 1890, usuarios: 4800 },
  { name: 'Jun', receita: 2390, usuarios: 3800 },
  { name: 'Jul', receita: 3490, usuarios: 4300 },
];
  ...
  <ResponsiveContainer width="100%" height="100%">
    <LineChart data={trendData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
      ...
      <Tooltip 
        ...
        itemStyle={{ color: '#e2e8f0' }}
      />
      <Line type="monotone" dataKey="valor" stroke="#ec4899" strokeWidth={3} dot={{ r: 4, fill: '#ec4899' }} activeDot={{ r: 6 }} />
    </LineChart>
  </ResponsiveContainer>
);
    ...
    <div className="flex flex-col h-full w-full gap-5 pb-4 pr-1">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 shrink-0">
        <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 rounded-xl p-5 border border-slate-700/50 shadow-lg relative overflow-hidden">
          ...
          <div className="text-slate-400 text-sm mb-1 font-medium">Volume Total Anual</div>
          <div className="text-3xl font-bold text-white tracking-tight">2.4M</div>
          <div className="text-sm text-emerald-400 mt-2 flex items-center gap-1 font-medium">↑ 12.5% vs ano ant.</div>
        </div>
