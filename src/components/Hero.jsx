  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center items-center overflow-hidden pt-10 pb-10">
      ...
      <div className="container relative z-10 text-center flex flex-col items-center">
        ...
        <motion.p 
          className="text-xl md:text-2xl text-slate-300 max-w-3xl mb-14"
          initial={{ opacity: 0 }}
        ...
        >
          <a href="#gallery" className="px-10 py-5 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white text-lg font-semibold transition-all shadow-[0_0_20px_rgba(37,99,235,0.4)] hover:shadow-[0_0_40px_rgba(37,99,235,0.6)] hover:-translate-y-1">
            Explorar Painéis
          </a>
          <a href="https://wa.me/55061995164994" target="_blank" rel="noopener noreferrer" className="px-10 py-5 rounded-2xl glass-panel text-white text-lg font-semibold flex items-center gap-2 group cursor-pointer border border-white/10 hover:border-white/30 transition-transform hover:-translate-y-1">
